...
pub const ecs_group_by_action_t = core.ecs_group_by_action_t;
pub const ecs_group_create_action_t = core.ecs_group_create_action_t;
pub const ecs_group_delete_action_t = core.ecs_group_delete_action_t;
pub const ecs_order_by_action_t = core.ecs_order_by_action_t;
pub const ecs_query_desc_t = core.ecs_query_desc_t;
pub const ecs_sort_table_action_t = core.ecs_sort_table_action_t;
